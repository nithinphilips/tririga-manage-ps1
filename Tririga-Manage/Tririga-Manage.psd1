...
FunctionsToExport = 'Initialize-Configuration', 'Get-Environment', 'Get-Instance', 
               ...
               'Open-Log', 'Enter-Host', 'Open-Web', 'Open-RDP', 'Open-RDPDatabase', 
               'Open-Folder', 'Save-Omp', 'Import-Omp', 'Open-WasFolder', 'Open-WasWeb', 
               'Get-WasLog', 'Open-WasLog', 'Open-WlpFolder', 'Get-WlpLog', 
               'Open-WlpLog'
