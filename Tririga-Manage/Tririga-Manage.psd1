...
FunctionsToExport = 'Initialize-Configuration', 'Get-Environment', 'Get-Instance', 
               'Get-Service', 'Get-ServiceMssql', 'Start-Service', 'Stop-Service', 
               'Restart-Service', 'Disable-Service', 'Enable-Service', 'Open-Database', 
               'Get-Log', 'Open-Log', 'Enter-Host', 'Enter-HostDb', 'Open-Web', 'Open-RDP', 
               'Open-RDPDb', 'Get-DatabaseHost', 'Open-Folder', 'Save-Omp', 'Import-Omp', 
               'Open-WasFolder', 'Open-WasWeb', 'Get-WasLog', 'Open-WasLog', 
               'Open-WlpFolder', 'Get-WlpLog', 'Open-WlpLog'
