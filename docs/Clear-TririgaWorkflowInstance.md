...
```
Clear-TririgaWorkflowInstance [-environment] <String> [-instance <String>] [-truncate] [-force]
...
### -truncate
Perform a truncate of workflow instances.
This removes any workflows not running or waiting for user
