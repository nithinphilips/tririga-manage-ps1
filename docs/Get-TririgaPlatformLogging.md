...
```
Get-TririgaPlatformLogging [-environment] <String> [-instance <String>] [-enabled] [-level <Int32>]
...
Set to higher number (like 99) to see all levels.
